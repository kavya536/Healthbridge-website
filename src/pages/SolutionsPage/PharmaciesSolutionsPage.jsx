            ...
            <div className="profile-card payment-gateway-card">
              ...
              <div className="payment-options-list">
                  ...
                  <div className="payment-method-content">
                    <div className="pay-svg-icon phonepe-purple">
                      ...
                      <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path d="M11 12H13.5C14.33 12 15 12.67 15 13.5C15 14.33 14.33 15 13.5 15H12V18H11V12Z" fill="#FFE066"/>
                      </svg>
                    </div>
                ...
                <label className={`payment-method-item ${selectedPayment === 'Paytm Wallet' ? 'method-selected' : ''}`}>
                  ...
                  <span className="payment-radio-custom"></span>
                  <div className="payment-method-content">
                    <div className="pay-svg-icon paytm-blue">
                      {/* Authentic Paytm dual-blue logo */}
                      <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <rect width="24" height="24" rx="6" fill="#00baf2"/>
                        <path d="M5 8.5V15.5H7.5V12.5H10C11.5 12.5 12 11.5 12 10V8.5H5ZM7.5 10.5H9.5V9.5H7.5V10.5Z" fill="white"/>
                        <path d="M12 9.5H16.5C17.5 9.5 18 10 18 11V15.5H15.5V12.5H13.5V15.5H12V9.5Z" fill="#002970"/>
                      </svg>
                    </div>
                ...
                <label className={`payment-method-item ${selectedPayment === 'Google Pay' ? 'method-selected' : ''}`}>
                  ...
                  <span className="payment-radio-custom"></span>
                  <div className="payment-method-content">
                    <div className="pay-svg-icon gpay-teal">
                      {/* Authentic Google multicolor G-symbol */}
                      <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <rect width="24" height="24" rx="6" fill="#FFFFFF"/>
                        <path d="M17.25 10.3C17.25 9.87 17.21 9.44 17.14 9.02H12V11.45H14.95C14.82 12.13 14.43 12.72 13.85 13.11V14.68H16.03C17.31 13.5 18.05 11.76 18.05 9.71C18.05 9.9 17.25 10.3 17.25 10.3Z" fill="#4285F4"/>
                        <path d="M12 15C13.62 15 14.98 14.46 15.97 13.54L13.85 11.89C13.26 12.28 12.51 12.54 11.66 12.54C10.1 12.54 8.78 11.49 8.31 10.07H6.06V11.81C7.05 13.78 9.09 15 12 15Z" fill="#34A853"/>
                        <path d="M8.31 10.07C8.19 9.71 8.12 9.32 8.12 8.93C8.12 8.54 8.19 8.15 8.31 7.79V6.05H6.06C5.65 6.87 5.41 7.79 5.41 8.77C5.41 9.75 5.65 10.67 6.06 11.49L8.31 10.07Z" fill="#FBBC05"/>
                        <path d="M12 5.33C12.88 5.33 13.67 5.63 14.29 6.22L16.05 4.46C14.97 3.46 13.61 2.85 12 2.85C9.09 2.85 7.05 4.07 6.06 6.05L8.31 7.79C8.78 6.37 10.1 5.33 12 5.33Z" fill="#EA4335"/>
                      </svg>
                    </div>
