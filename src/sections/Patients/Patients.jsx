      ...
      <div className="patients-container">
        ...
        <div className="patients-content">
          ...
          <h2 className="section-title">
            ...
            <span className="text-teal" style={{ color: '#20C7B6', textTransform: 'none', fontSize: 'inherit', fontWeight: 'inherit', lineHeight: 'inherit', fontFamily: 'inherit' }}>Of Your Healthcare Journey</span>
          </h2>
